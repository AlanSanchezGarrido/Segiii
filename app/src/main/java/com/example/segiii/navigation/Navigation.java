...
public class Navigation {
    ...
    public Navigation(Activity activity, SupportNavigationFragment mNavFragment, LatLng coordinates) {
    ...
    public Navigation(Activity activity, SupportNavigationFragment mNavFragment, String destination) {
        this.mNavFragment = mNavFragment;
        this.activity = activity;
        this.context = activity.getApplicationContext();
    ...
    private void navigateToPlace(LatLng coordinates) {
        Waypoint destination;
        try {
            destination = Waypoint.builder().setLatLng(coordinates.latitude, coordinates.longitude).build();
    ...
    private void displayMessage(String errorMessage) {
        ...
        Log.d("ERROR Navigation:", errorMessage);
    }
